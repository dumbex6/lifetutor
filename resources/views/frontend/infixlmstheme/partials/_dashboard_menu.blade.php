                    ...
                    <div class="notification_menu">
                        <ul>
                            @foreach (Auth::user()->unreadNotifications as $notification)
                                ...
                                <li>
                                    <a href="{{$notification->data['actionURL']??'#'}}" class="unread_notification" title="Mark As Read" data-notification_id="{{$notification->id}}">
                        ...
                        <div class="notification_footer">
                            <a href="{{route('myNotification')}}" class="readMore_text theme_btn small_btn2 p-2 m-1 ">{{__('common.Read more')}}</a>
                            <a href="{{route('NotificationMakeAllRead')}}" class="readMore_text theme_btn small_btn2 p-2 m-1 ">{{__('common.Mark As Read')}}</a>
                        </div>
                    </div>
                </li>
                <li>
